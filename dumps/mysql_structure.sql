...
--
-- Hostiteľ: localhost
-- Vygenerované:: 27.Apr, 2013 - 13:22
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=8584 ;
...
CREATE TABLE IF NOT EXISTS `fields` (
  ...
  KEY `id_panel` (`id_panel`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14786 ;
...
CREATE TABLE IF NOT EXISTS `panels` (
  ...
  KEY `id_parent` (`id_parent`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4120 ;
